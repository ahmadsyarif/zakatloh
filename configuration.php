...
class JConfig
{
	...
	public $sitename = 'Zakat Infaq Sadaqah\'s Site!';            // Name of Joomla site
	...
	public $password = '43efc6a45a';                   // DB password
	public $db = 'bitnami_joomla';                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'c1bfc19b86bfe5c9d29726efe7458b7d';     // Change this to something more secure
	public $gzip = '0';
